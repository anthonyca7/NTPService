This project requires SBT 0.13.6 and probably any version 0.13.x works well for this project. The project was implements using Akka and tested using Akka TestKit with ScalaTest.
